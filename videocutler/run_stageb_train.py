...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument('--dataset_name', default='lvvis_train_base', choices=('lvvis_train_base','lvvis_val')); p.add_argument('--trajectory_source_branch', default='mainline', choices=('mainline','gt_upper_bound')); p.add_argument('--pipeline', default='legacy', choices=('legacy','reservoir_v1')); p.add_argument('--training_semantics', default='legacy_scta', choices=('legacy_scta','reservoir_release')); p.add_argument('--stage_scope', default='prealign_base_aug', choices=('prealign_only','prealign_base','prealign_base_aug')); p.add_argument('--smoke_max_trajectories', type=int, default=128)
    ...
    p.add_argument('--weight_decay', type=float, default=1e-2); p.add_argument('--unknown_mode', default='prototype', choices=('prototype','scalar_bias')); p.add_argument('--t_dis_init', type=float, default=0.07); p.add_argument('--lambda_frame', type=float, default=None); p.add_argument('--lambda_cov', type=float, default=1.0); p.add_argument('--subset_fraction', type=float, default=None); p.add_argument('--batch_budget', type=int, default=None); p.add_argument('--k_extra', type=int, default=2); p.add_argument('--extra_alpha', type=float, default=0.25); p.add_argument('--base_release_margin', type=float, default=0.0); p.add_argument('--em_subiterations', type=int, default=2); p.add_argument('--base_em_refresh_policy', default='stage_once', choices=('stage_once','epoch_start')); p.add_argument('--ablate_skip_base', type=_parse_bool, default=False); p.add_argument('--ablate_no_yprime_reward', type=_parse_bool, default=False); p.add_argument('--show_progress', type=_parse_bool, default=True); p.add_argument('--log_every', type=int, default=10); p.add_argument('--write_runtime_metrics_jsonl', type=_parse_bool, default=True); p.add_argument('--print_epoch_summary', type=_parse_bool, default=True)
    return p.parse_args()
def main() -> int:
