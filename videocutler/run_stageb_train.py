...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument('--weight_decay', type=float, default=1e-2); p.add_argument('--t_dis_init', type=float, default=0.07); p.add_argument('--lambda_frame', type=float, default=None); p.add_argument('--lambda_cov', type=float, default=1.0); p.add_argument('--subset_fraction', type=float, default=None); p.add_argument('--batch_budget', type=int, default=None); p.add_argument('--base_release_margin', type=float, default=0.0); p.add_argument('--ablate_skip_base', type=_parse_bool, default=False); p.add_argument('--ablate_no_yprime_reward', type=_parse_bool, default=False); p.add_argument('--show_progress', type=_parse_bool, default=True); p.add_argument('--log_every', type=int, default=10); p.add_argument('--write_runtime_metrics_jsonl', type=_parse_bool, default=True); p.add_argument('--print_epoch_summary', type=_parse_bool, default=True)
    return p.parse_args()
def main() -> int:
