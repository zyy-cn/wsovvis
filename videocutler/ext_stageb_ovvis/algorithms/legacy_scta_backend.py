...
def _compute_clip_refinement_rows_unknown(*, stage_id: str, unknown_init_mode: str, clip_examples: Sequence[Mapping[str, Any]], base_cache: ResponsibilityCache, text_projector: Projector, theta_t: torch.nn.Parameter, unknown_prototype: torch.nn.Parameter, b_u: torch.nn.Parameter, unknown_mode: str, em_subiterations: int, lambda_cov: float, device: torch.device) -> Tuple[List[Record], List[Dict[str, Any]]]:
