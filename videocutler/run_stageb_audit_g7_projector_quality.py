...
def _summary_path(repo_root: Path) -> Path:
    return repo_root / "codex" / "outputs" / "G7_training" / "g7_stagewise_projector_quality_latest.json"


def _summary_md_path(repo_root: Path) -> Path:
    return repo_root / "codex" / "outputs" / "G7_training" / "g7_stagewise_projector_quality_latest.md"
...
def main() -> int:
    ...
    payload.update(
        {
            ...
            "gate_id": "G7_training",
            "phase_scope": "stagewise_projector_quality_audit",
            ...
            "artifacts": {
                ...
                "hand_off_md": "codex/outputs/G7_training/g7_stagewise_projector_quality_latest.md",
                "hand_off_json": "codex/outputs/G7_training/g7_stagewise_projector_quality_latest.json",
            },
            "current_asset_mode_behavior": "bounded_provisional_stagewise_projector_quality_audit_with_offline_gt_sidecar",
            "blocked_follow_up_items": [
                "G7 formal closure remains a separate task",
                "projector quality audit is diagnostic-only evidence",
            ],
        }
    )
    ...
    _write_md(
        ...
        [
            ...
            "- training_semantics_changed: false",
            "- formal_training_ready: false",
            "- emitted_artifacts: train/audit/prealign_projector_quality.json, train/audit/softem_base_projector_quality.json, train/audit/softem_aug_projector_quality.json, train/audit/stagewise_projector_quality_transition_summary.json",
            "- blocked_follow_up_items:",
            "  - G7 formal closure remains a separate task",
            "  - projector quality audit is diagnostic-only evidence",
        ],
