...
def _write_smoke_config(path: Path, weights_path: str) -> None:
...
def main() -> int:
    ...
    parser.add_argument(
        "--weights-path",
        default="/home/zyy/code/wsovvis_live/runs/wsovvis_seqformer/15/d2/model_0005999.pth",
        help="Model weights path for deterministic low-cost smoke",
    )
    parser.add_argument(
        "--python-bin",
    ...
    _write_smoke_config(config_path, args.weights_path)
