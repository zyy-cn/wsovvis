...
## 1. Protocol / contract failure modes (G1)
...
## 2. Structure failure modes (G2 / G3)
...
2. tune only bounded thresholds / weights
...
## 5. Attribution failure modes (G6)
...
## 6. Bag-free inference failure modes (G7)
...
## 7. Environment / validation failure modes
...
5. do not substitute informal evidence for missing canonical evidence when canonical evidence is required
